...
class MtgCardPictureContainer extends GetView<MtgCreateCardController> {
  const MtgCardPictureContainer({Key? key}) : super(key: key);
          ...
          Positioned(
            ...
            child: Container(
              ...
              child: Obx(() => controller.coverImage.value != ''
                  ...
                  : Image.asset("assets/images/mtg_logo_full.png",
                          ...
                          child: Stack(
                            ...
                            children: [
                              ...
                              Material(
                                shape: const CircleBorder(),
                                elevation: 3,
                                color: blackColor.withOpacity(controller.logoImage.value != '' ? 0.2 : 0.5),
                                child: InkWell(
                                  onTap: () {
