...
class CardPreviewModel {
  ...
  final int colorLink;
  final List<SocialLinkModel> contacts;

  CardPreviewModel copyWith({
    int? id,
    String? cardId,
    int? userId,
    String? themeColor,
  ...
  factory CardPreviewModel.fromJson(String str) => CardPreviewModel.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory CardPreviewModel.fromMap(Map<String, dynamic> json) => CardPreviewModel(
    id: json["id"] ?? 0,
    cardId: json["card_id"] ?? '',
    ...
    contacts: json["contacts"] == null
        ? []
        : List<SocialLinkModel>.from(json["contacts"].map((x) => SocialLinkModel.fromMap(x))),
  );
