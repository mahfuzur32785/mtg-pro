...
class CardViewHistoryController extends GetxController {
  final InsightsRepository _insightsRepository;
  final LoginController _loginController;
  CardViewHistoryController(this._loginController,this._insightsRepository);
  ...
  Future<void> getCardViewData({bool isLoad = true}) async {
    ...
    final uri = Uri.parse(RemoteUrls.getCardViewHistory);
