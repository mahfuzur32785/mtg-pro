...
import '../controller/contact_download_history_controller.dart';

class ContactDownloadHistoryScreen extends GetView<ContactDownloadHistoryController> {
  const ContactDownloadHistoryScreen({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar().simpleAppBar("Contact Download History"),
